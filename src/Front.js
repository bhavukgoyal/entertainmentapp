...
const Test = () => {
    ...
    useEffect(() => {
        const fetchDatatv = async () => {
            ...
            try {
                const responsetv = await fetch('https://api.themoviedb.org/3/movie/popular?language=en-US&page=1', optionstv);
    ...
    return (
        ...
        <ul style={{ listStyle: 'none', padding: 0 }}>
            ...
            <li style={{ padding: '10px' }}>
                <Link to="/Movies" style={{ color: 'red', fontSize: '2em', textDecoration: 'none' }} >
                    <BiCameraMovie />
                </Link>
            </li>
            <li style={{ padding: '10px' }}>
